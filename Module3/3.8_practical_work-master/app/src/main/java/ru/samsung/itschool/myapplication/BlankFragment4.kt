...
class BlankFragment4 : Fragment() {
    ...
    override fun onCreateView(
        ...
        btn6.setOnClickListener(View.OnClickListener { v ->
            // создаем бандл
            val bundle: Bundle = Bundle()
            // вносим в него значения
            bundle.putString("arg1", et.text.toString())
            // выполняем навигацию с передачей данных
            v.findNavController().navigate(R.id.action_blankFragment4_to_main2Activity, bundle)
        })
        val btn6_up: Button = view.findViewById(R.id.button6_up)
        btn6_up.setOnClickListener(View.OnClickListener { v ->
            v.findNavController().navigateUp()
        })
        val btn7: Button = view.findViewById(R.id.button7)
        btn7.setOnClickListener(View.OnClickListener { v ->
            v.findNavController().navigate(R.id.action_blankFragment4_to_blankFragment32)
        })
