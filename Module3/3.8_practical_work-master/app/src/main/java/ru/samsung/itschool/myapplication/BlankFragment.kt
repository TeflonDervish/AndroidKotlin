...
class BlankFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btn3.setOnClickListener(View.OnClickListener { v ->
            v.findNavController().navigate(R.id.action_blankFragment_to_blankFragment3)
        })
        // ============= Button5 обработчик, способ записи 3
        view.findViewById<Button>(R.id.button5)
            .setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_blankFragment_to_blankFragment4))
        return view
    }
